...
export class Property<K extends PropertyKind> {
    ...
    unbindTwoWay(other: Property<K>): void {
        // oxlint-disable-next-line unicorn/no-useless-spread -- snapshot before unbind() mutates this.links
    ...
    private async update(
        ...
        // oxlint-disable-next-line unicorn/no-useless-spread -- snapshot in case a handler mutates this.observers
