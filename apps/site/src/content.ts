import { SUPPORT_EMAIL } from "@extra-domain-filters/shared/config/links";

export { CHROME_WEB_STORE_URL, GITHUB_URL, SUPPORT_EMAIL } from "@extra-domain-filters/shared/config/links";
